    ...
    <Fragment>
      <div className={styles.container}>
        ...
        <p className={styles.introText}>
          Hi! <br />
          My name is <span>Shushanik</span>, I am a junior frontend developer intern at <span>Epam Systems</span>
        </p>
        ...
        <div className={styles.socialLinks}>
          <a href="https://github.com/Shushanik01" target="_blank" rel="noopener noreferrer">
            <img src={githubIcon} alt="github icon" />
          </a>
          <a href="https://www.linkedin.com/in/shushanik-arakelyan-4b763b365/" target="_blank" rel="noopener noreferrer">
